...
@section('content')
	...
	<h1 class="text-primary" style="padding:7%;">Eletrodomesticos</h1>
	...
	<center>	
		<nav aria-label="Page navigation example">
		  <ul class="pagination">
		    <li class="page-item">
		      <a class="page-link" href="{!! route('Eletrodomesticos') !!}/{{$ant}}" aria-label="Voltar">
		    ...
		    @for($i = 1; $i <= ceil(count($paginar) / 5); $i++)
			    ...
			    <li class="page-item">
			    	<a class="page-link" href="{!! route('Eletrodomesticos') !!}/{{$i}}">{{$i}}</a>
			    </li>

		    @endfor

		    <li class="page-item">
		      <a class="page-link" href="{!! route('Eletrodomesticos') !!}/{{$nx}}" aria-label="Proximo">
