...
@section('content')
	...
	<h1 class="text-primary" style="padding:7%;">Moveis</h1>
	...
	<center>	
		<nav aria-label="Page navigation example">
		  <ul class="pagination">
		    <li class="page-item">
		      <a class="page-link" href="{!! route('Moveis') !!}/{{$ant}}" aria-label="Voltar">
		    ...
		    @for($i = 1; $i <= ceil(count($paginar) / 5); $i++)
			    ...
			    <li class="page-item">
			    	<a class="page-link" href="{!! route('Moveis') !!}/{{$i}}">{{$i}}</a>
			    </li>

		    @endfor

		    <li class="page-item">
		      <a class="page-link" href="{!! route('Moveis') !!}/{{$nx}}" aria-label="Proximo">
